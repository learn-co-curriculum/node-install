...
You'll have to restart your terminal first and after that, harness NVM's `install` to install version 5.1.0 of Node:
...
<p class='util--hide'>View <a href='https://learn.co/lessons/node-install-lab'>Installing Node and npm</a> on Learn.co and start learning to code for free.</p>
